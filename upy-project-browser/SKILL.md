...
description: Use when converting upstream MicroPython skill workflows for end to end browser MicroPython project orchestration into browser-hosted primitives.
---

# upy-project-browser

Source skills: upy-project.
