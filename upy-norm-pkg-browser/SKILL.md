...
description: Use when converting upstream MicroPython skill workflows for package layout normalization into browser-hosted primitives.
---

# upy-norm-pkg-browser

Source skills: upy-norm-pkg.
