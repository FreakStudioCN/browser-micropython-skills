...
description: Use when converting upstream MicroPython skill workflows for interactive board probing and short command execution into browser-hosted primitives.
---

# webserial-device-interaction-browser

Source skills: mpremote-device-interaction.
