...
description: Use when converting upstream MicroPython skill workflows for package metadata and dependency planning into browser-hosted primitives.
---

# upy-gen-pkg-browser

Source skills: upy-gen-pkg.
