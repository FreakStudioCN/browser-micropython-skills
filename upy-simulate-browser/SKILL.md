...
description: Phase 4.5 — PC-side full-flow business simulation inside Blockless Web Builder. Reads all firmware/ code, the LLM designs scheduler/mock/visualization/scenarios, generates test/pc/ simulation scripts, validates and runs them. Triggers after upy-generate-browser, or after upy-autofix-browser fixes.
---
