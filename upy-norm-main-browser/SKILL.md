...
description: Use when converting upstream MicroPython skill workflows for main program normalization into browser-hosted primitives.
---

# upy-norm-main-browser

Source skills: upy-norm-main.
