...
description: Use when converting upstream MicroPython skill workflows for main program generation into browser-hosted primitives.
---

# upy-gen-main-browser

Source skills: upy-gen-main.
