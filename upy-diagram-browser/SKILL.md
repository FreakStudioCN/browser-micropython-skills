...
description: Use when converting upstream MicroPython skill workflows for project diagrams and rendered diagram artifacts into browser-hosted primitives.
---

# upy-diagram-browser

Source skills: upy-diagram.
